    ...
    <Card className="border border-border/40 bg-card rounded-2xl shadow-sm">
      <CardHeader className="flex items-center gap-2 space-y-0 border-b border-border/40 py-5 sm:flex-row">
        <div className="grid flex-1 gap-1">
          <CardTitle className="ui-title">Grafik Kunjungan & Transaksi</CardTitle>
          <CardDescription className="ui-label">
            Menampilkan data pengunjung selama {timeRange === '90d' ? '3 bulan' : timeRange === '30d' ? '30 hari' : '7 hari'} terakhir
          </CardDescription>
        </div>
